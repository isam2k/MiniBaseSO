    ...
    class MiniBaseBiomeProfiles
    {
        ...
        public static MiniBaseBiomeProfile SwampProfile = new MiniBaseBiomeProfile(
            ...
            new BandInfo[]
            {
                ...
                new BandInfo(0.30f, SimHashes.SlimeMold, disease: MiniBaseOptions.DiseaseID.Slimelung),
                ...
                new BandInfo(0.73f, SimHashes.SlimeMold, disease: MiniBaseOptions.DiseaseID.Slimelung),
        ...
        public static MiniBaseBiomeProfile StrangeProfile = new MiniBaseBiomeProfile(
            ...
            new BandInfo[]
            {
                ...
                new BandInfo(0.82f, SimHashes.SlimeMold, disease: MiniBaseOptions.DiseaseID.Slimelung),
                ...
                new BandInfo(1.00f, SimHashes.DirtyWater, disease: MiniBaseOptions.DiseaseID.FoodPoisoning),
            },
            startingItems:
            new List<KeyValuePair<string, float>>()
            {
        ...
        public static MiniBaseBiomeProfile OilMoonletProfile = new MiniBaseBiomeProfile(
            "subworlds/oil/OilPatch",
            SimHashes.Fossil,
            333f,
            new BandInfo[]
            {
                ...
                new BandInfo(0.34f, SimHashes.Fossil),
                new BandInfo(0.36f, SimHashes.Sand),
                new BandInfo(0.44f, SimHashes.Sulfur),
                new BandInfo(0.47f, SimHashes.Sucrose),
                new BandInfo(0.50f, SimHashes.Sand),
                new BandInfo(0.53f, SimHashes.Sand),
                new BandInfo(0.56f, SimHashes.Diamond),
                new BandInfo(0.65f, SimHashes.Lead),
                new BandInfo(0.67f, SimHashes.Sand),
                new BandInfo(0.70f, SimHashes.Sulfur),
                new BandInfo(0.80f, SimHashes.CarbonDioxide, density: 2f),
                new BandInfo(0.96f, SimHashes.SandStone),
            ...
            new Dictionary<string, float>()
            {
                { "DivergentBeetle", 0.005f },
                { "ForestForagePlant", 0.010f },
                { "WormPlantSeed", 0.010f },
                { "CactusPlantSeed", 0.005f },
            },
            spawnablesInAir:
            new Dictionary<string, float>()
        ...
        public static MiniBaseBiomeProfile NiobiumMoonletProfile = new MiniBaseBiomeProfile(
            "subworlds/oil/OilPatch",
            SimHashes.Obsidian,
            1873f,
            new BandInfo[]
            {
                ...
                new BandInfo(0.4f, SimHashes.Magma),
                new BandInfo(0.6f, SimHashes.Obsidian),
                new BandInfo(0.7f, SimHashes.Magma),
                new BandInfo(0.8f, SimHashes.Obsidian),
                new BandInfo(0.86f, SimHashes.Niobium),
