...
namespace MiniBase.Model.Profiles
{
    class MiniBaseCoreBiomeProfiles
    {
        ...
        public static MiniBaseBiomeProfile RadioactiveCoreProfile = new MiniBaseBiomeProfile(
            null,
            SimHashes.Ice,
            254f,
            new BandInfo[]
            {
                ...
                new BandInfo(0.26f, SimHashes.BleachStone, density: 2f),
                new BandInfo(0.33f, SimHashes.Ice, density: 4f),
                new BandInfo(0.37f, SimHashes.UraniumOre, density: 4f),
                new BandInfo(0.41f, SimHashes.Wolframite, density: 2f),
                new BandInfo(0.49f, SimHashes.ChlorineGas, density: 2f),
                new BandInfo(0.56f, SimHashes.UraniumOre, density: 4f),
                new BandInfo(0.60f, SimHashes.UraniumOre, density: 4f),
                new BandInfo(0.65f, SimHashes.Ice, density: 2f),
                new BandInfo(0.69f, SimHashes.Wolframite, density: 2f),
                new BandInfo(0.73f, SimHashes.UraniumOre, density: 2f),
                new BandInfo(0.76f, SimHashes.CarbonDioxide, density: 2f),
                new BandInfo(0.81f, SimHashes.UraniumOre, density: 2f),
                new BandInfo(1.00f, SimHashes.CarbonDioxide, density: 2f),
            },
            spawnablesOnFloor:
            new Dictionary<string, float>()
            {
                { "ColdBreather", 0.01f },
                { "CritterTrapPlant", 0.005f },
                { "ToePlant", 0.05f },
            },
            spawnablesInGround:
            new Dictionary<string, float>()
            {
                { "CritterTrapPlantSeed", 0.005f },
                { "ColdBreatherSeed", 0.01f },
            },
            spawnablesInAir:
            new Dictionary<string, float>()
            {
                { "PuftBleachstone", 0.01f },
            });
    }
}
